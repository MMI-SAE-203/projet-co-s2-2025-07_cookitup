...
</p> </div> </section> <!-- Pricing Section --> <section class="py-12 bg-red-300 text-gray-800"> <div class="max-w-6xl mx-auto px-4"> <div class="flex flex-col lg:flex-row items-center gap-8"> <div class="flex-1"> <div class="rounded-xl overflow-hidden shadow-lg"> <img src="/placeholder.svg?height=400&width=600" alt="Plats gastronomiques" class="w-full h-auto object-cover"> </div> </div> <div class="flex-1 text-center lg:text-left"> <p class="text-2xl lg:text-3xl font-semibold mb-4 leading-relaxed">
